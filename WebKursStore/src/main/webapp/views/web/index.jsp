...
<!-- //for-mobile-apps -->
<link href="/WebKurs2/views/web/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="/WebKurs2/views/web/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- font-awesome icons -->
<link href="/WebKurs2/views/web/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<!-- js -->
	...
	<div class="agileits_header">
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					<li><a href="/WebKurs2/regView"> Create Account </a></li>
					<li><a href="/WebKurs2/lg">Login</a></li>
...
<link href="/WebKurs2/views/web/css/skdslider.css" rel="stylesheet">
<script type="text/javascript">
		jQuery(document).ready(function(){
